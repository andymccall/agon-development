...
This program displays and moves a sprite around the screen, using frames
...
```
username@host:~$ cd agon-development/08-spriteframes/asm
username@host:~$ make
Building project...
mkdir -p bin
...
Output size   : 1581
mv src/main.bin bin/spriteframes.bin
```
...
```
/ * load spriteframes.bin
/ * run
```

You should see something similar to the following:

![Screenshot of the Fab Emulator](https://github.com/andymccall/agon-development/blob/main/08-spriteframes/assets/08-spriteframes_asm.png?raw=true)
